...
public class IkLeg : MonoBehaviour
{
    ...
    [SerializeField] private float legLenth;
    ...
    private void OnEnable()
    {
        ...
        //data = GetComponentInParent<Unparent>().parent.GetComponent<BaseCharacter>();
    ...
    {
        Vector2 b = deltaPos * prediction;
        Vector2 origin = data.transform.position + base.transform.right * base.transform.localPosition.x;
        Vector2 direction = Vector2.down + b;
        float distance = legLenth * 1.5f * scale + b.magnitude;
