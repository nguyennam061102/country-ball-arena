...
namespace RootMotion.FinalIK
{
	...
	public class IKConstraintBend
	{
		...
		public Vector3 GetDir(IKSolverFullBody solver)
		{
			...
			Vector3 vector2 = Quaternion.FromToRotation(bone3.position - bone1.position, vector) * (bone2.position - bone1.position);
			...
			{
				vector2 = Quaternion.FromToRotation(rotationOffset * vector, vector) * rotationOffset * vector2;
			}
			if (num <= 0f)
			{
				return vector2;
